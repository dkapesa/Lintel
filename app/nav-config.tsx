...
export const SHELL_ROUTE_CONTEXTS: ShellRouteContext[] = [
  ...
  },
  {
    ...
    routeDescription: "Inspect browser-local responsibility metadata and unavailable collaboration boundaries.",
  ...
  },
  {
    ...
    routeDescription: "Inspect bundled policy profiles, intake applicability, impact preview and non-enforcement boundaries.",
    scopeLabel: "Bundled governance",
