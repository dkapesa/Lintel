...
/* R3C.1 — the evidence landscape (R3B §7.12, §12).
   ...
   weight. Three changes give it a resolution:
     ...
     1. A single left-to-right stroke gradient (#lv3Travel) runs through the
...
const INK = "var(--lv3-rule-ink)";
const RULE = "var(--lv3-rule-strong)";
const FAINT = "var(--lv3-rule)";
const BRONZE = "var(--lv3-bronze)";
const LABEL = "var(--lv3-ink-3)";
const MARK = "var(--lv3-ink-4)";
...
export function FooterSceneWide() {
  return (
    <svg
      ...
      role="img"
      aria-label="An engineering drawing of the verification sequence: loose branch lines on the left gather into ruled evidence structures beneath a shelf, pass three standing requirement plates, and converge on a single resolved bronze decision marker at the right."
      fill="none"
      strokeLinecap="square"
    >
      <defs>
        {/* The scene darkens as it becomes more accountable. */}
        <linearGradient id="lv3Travel" x1="0" y1="0" x2="1440" y2="0" gradientUnits="userSpaceOnUse">
        ...
        <pattern id="lv3Halftone" width="6" height="6" patternUnits="userSpaceOnUse">
          <circle cx="1.4" cy="1.4" r="0.85" fill={INK} fillOpacity="0.34" />
          <circle cx="4.4" cy="4.4" r="0.55" fill={INK} fillOpacity="0.22" />
        </pattern>
        <pattern id="lv3Halftone2" width="7" height="7" patternUnits="userSpaceOnUse">
      ...
      <g opacity="0.7">
        ...
        <text x={208} y={50} fill={MARK} fontFamily="var(--lv3-mono)" fontSize="9" letterSpacing="1.4">
      ...
      <g stroke="url(#lv3Travel)" strokeWidth="1.15">
      ...
      <g stroke="url(#lv3Travel)" strokeWidth="0.9" opacity="0.72">
      ...
      <circle cx="56" cy="232" r="4.5" fill="var(--lv3-canvas)" stroke={RULE} strokeWidth="1.4" />
      ...
      {[
        ...
        <circle key={`${cx}-${cy}`} cx={cx} cy={cy} r="3" fill="var(--lv3-canvas)" stroke={RULE} strokeWidth="1" />
      ))}
      <text x={56} y={214} fill={MARK} fontFamily="var(--lv3-mono)" fontSize="9" letterSpacing="1.3">
        HEAD
      </text>
      ...
      <path
        ...
        stroke="url(#lv3Travel)"
        strokeWidth="0.9"
        opacity="0.55"
      />
      {STEMS.map((stem) => (
        <g key={stem.x}>
          <path d={`M${stem.x} 270 L${stem.x} ${stem.top}`} stroke="url(#lv3Travel)" strokeWidth="1.2" />
          <path d={`M${stem.x - 5} ${stem.top} L${stem.x + 5} ${stem.top}`} stroke="url(#lv3Travel)" strokeWidth="1.2" />
          {stem.bars.map((bar) => (
            <rect
              key={bar.y}
              x={stem.x + 4}
              ...
              strokeWidth="0.9"
              fill={
                bar.fill === "solid" ? INK : bar.fill === "halftone" ? "url(#lv3Halftone)" : "none"
              }
      ...
      <g stroke="url(#lv3Travel)" strokeWidth="1.3">
      ...
      <circle cx="1316" cy="190" r="5" fill="var(--lv3-canvas)" stroke={INK} strokeWidth="1.6" />
      ...
      <text x={1368} y={74} fill={LABEL} fontFamily="var(--lv3-mono)" fontSize="9" letterSpacing="1.4">
        DECISION
      </text>
...
export function FooterSceneNarrow() {
  return (
    <svg
      ...
      viewBox="0 0 480 200"
      role="img"
      aria-label="An engineering drawing of the end of the verification sequence: evidence structures and a marked requirement plate converge on a single resolved bronze decision marker."
      fill="none"
      strokeLinecap="square"
    >
      <defs>
        <linearGradient id="lv3TravelNarrow" x1="0" y1="0" x2="480" y2="0" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor={RULE} stopOpacity="0.5" />
          <stop offset="0.45" stopColor={INK} stopOpacity="0.8" />
          <stop offset="1" stopColor={INK} stopOpacity="1" />
        </linearGradient>
        <pattern id="lv3HalftoneNarrow" width="6" height="6" patternUnits="userSpaceOnUse">
          <circle cx="1.4" cy="1.4" r="0.85" fill={INK} fillOpacity="0.34" />
        </pattern>
      </defs>
      ...
      <g stroke="url(#lv3TravelNarrow)" strokeWidth="1.1">
      ...
      {[
        ...
        <g key={stem.x}>
          <path d={`M${stem.x} 158 L${stem.x} ${stem.top}`} stroke="url(#lv3TravelNarrow)" strokeWidth="1.2" />
          <path d={`M${stem.x - 4} ${stem.top} L${stem.x + 4} ${stem.top}`} stroke="url(#lv3TravelNarrow)" strokeWidth="1.2" />
      ...
      <rect x={336} y={78} width="28" height="80" stroke={INK} strokeWidth="1.35" fill="url(#lv3HalftoneNarrow)" />
      <text x={350} y={68} fill={LABEL} fontFamily="var(--lv3-mono)" fontSize="8.5" fontWeight="600" letterSpacing="0.9" textAnchor="middle">
        C1
      </text>

      <g stroke="url(#lv3TravelNarrow)" strokeWidth="1.25">
      ...
      <circle cx="436" cy="120" r="4.5" fill="var(--lv3-canvas)" stroke={INK} strokeWidth="1.5" />
      ...
      <text x={20} y={190} fill={LABEL} fontFamily="var(--lv3-mono)" fontSize="8" letterSpacing="1.3">
        CHANGE
      </text>
      <path d="M212 164 L212 176" stroke={RULE} strokeWidth="1" />
      <text x={212} y={190} fill={LABEL} fontFamily="var(--lv3-mono)" fontSize="8" letterSpacing="1.3">
        EVIDENCE
      </text>
      <path d="M396 164 L396 176" stroke={INK} strokeWidth="1" />
      <text x={396} y={190} fill={INK} fontFamily="var(--lv3-mono)" fontSize="8.5" fontWeight="600" letterSpacing="1.3">
        DECISION
      </text>
    </svg>
  );
