...
test("current action registry is exactly five actions", () => {
  deepEqual(WORKSTATION_BOUND_ACTION_IDS, ["route/navigate", "route/apply", "queue/set-manual-preference", "queue/show-narrow-surface", "review/select"], "five actions");
});
