...
type GitHubState = "checking" | "configured" | "not-configured" | "unavailable";
type NextInspection = {
  ...
  useEffect(() => {
    ...
    async function readStatus() {
      try {
        ...
        if (!active) return;
        setGithubState(payload.configured && payload.authenticated ? "configured" : payload.configured ? "unavailable" : "not-configured");
      } catch {
